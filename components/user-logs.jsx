...
/**
 * UserLogs reusable component
 * Props:
 *  - onClose?: () => void  // when provided, shows a close button and calls onClose instead of router.back()
 */
export default function UserLogs({ onClose }) {
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: '#fff' }}>
      ...
      >
        <TouchableOpacity onPress={handleBackOrClose}>
          {onClose ? (
            <X size={24} color="#0B3D91" />
          ) : (
