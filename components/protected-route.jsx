 ...
 */
const ProtectedRoute = ({ allowedTabs, children }) => {
  ...
  useEffect(() => {
    ...
    // Authorized user; enforce tab constraint if provided
    ...
    setReady(true);
  }, [loading, isPendingVerification, isAuthenticated, hasTabConstraint, tabAllowed, tabsArray, currentTab, router]);
